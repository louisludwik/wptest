            ...
            <div class="exp-container">
                ...
                ?>
                    ...
                    <div class="input-text-remind">
                        ...
                        <textarea type="text" required class="responsabilities" placeholder="<?php _e('Responsabilities', ET_DOMAIN); ?>"><?php echo $item['responsabilities'] ?></textarea>
                    ...
                    <div class="input-text-remind">
                        ...
                        <textarea type="text" required class="achievements" placeholder="<?php _e('Achievements', ET_DOMAIN); ?>"><?php echo $item['achievements'] ?></textarea>

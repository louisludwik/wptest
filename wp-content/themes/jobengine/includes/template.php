...
function je_header_menu () {
	...
	else if( is_post_type_archive('job') || get_post_type() == 'job' || ($user_role == 'jobseeker') ){
	...
	if ($user_role == 'company') {
		...
		array(
				...
				'label' 			=> __('BROWSE CVs', ET_DOMAIN),
				'link_attr' 		=> array('title' => __('BROWSE CVs', ET_DOMAIN)),
			),
			array(
	...
	$default_menu_items = apply_filters( 'default_menu_items', $args);

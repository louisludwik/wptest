<?php
/**
 * Class ET_Otions: equivalent to an option in wp_engine, we use this to group many options of our themes into 1
...
class ET_Options{
	 ...
	 */
	protected function __construct( $option_name = 'et_options ' ) {

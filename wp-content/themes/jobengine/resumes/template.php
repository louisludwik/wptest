...
?>
	...
	<script type="text/template" id="exp_template">
		...
		<div class="edu-form">
			...
			<div class="jse-input">
				...
				<textarea type="text" class="bg-default-input responsabilities" placeholder="<?php _e("Responsabilities", ET_DOMAIN); ?>"> </textarea>

			</div>
			
			<div class="jse-input">

				<textarea type="text" class="bg-default-input achievements" placeholder="<?php _e("Achievements", ET_DOMAIN); ?>"> </textarea> 
             ...
             <div class="jse-input">
                <label># Years Experience : 
                    ...
                    <# 
                        ...
                        var m = 0;
                        if (current == 1) {
                            y = <?php echo (int)date('Y') ?> - from.year;
                            m = <?php echo (int)date('m') ?> - from.month + 1;
                        } else {
                            y = to.year - from.year;
	...
	<script type="text/data" id="experience_view">
		...
		<div class="jse-input">
			...
			<textarea type="text" class="bg-default-input responsabilities" placeholder="<?php _e("Responsabilities", ET_DOMAIN); ?>">{{ responsabilities }}</textarea>

		</div>
		
		<div class="jse-input">

			<textarea type="text" class="bg-default-input achievements" placeholder="<?php _e("Achievements", ET_DOMAIN); ?>">{{ achievements }}</textarea> 

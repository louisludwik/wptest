	    		...
	    		<div class="input-text-remind">
	                ...
	                <div class="clear" style="clear:both; height:5px; overflow:hidden;"></div>
					 ...
					 <div class="input-text-remind">
	                    ...
	                    <input type="text" required class="position"  value="" placeholder="<?php _e('Responsabilities', ET_DOMAIN); ?>">
	                ...
	                <div class="clear" style="clear:both; height:5px; overflow:hidden;"></div>
					 ...
					 <div class="input-text-remind">
	                    ...
	                    <input type="text" required class="position"  value="" placeholder="<?php _e('Achievements', ET_DOMAIN); ?>">

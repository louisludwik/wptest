...
<div class="tab-account">
	...
	<div class="main-center">
		...
		<ul class="tabs">
        	...
        	<li rel="jse-basic-info" class="basic-info"><?php _e("PERSONAL INFO", ET_DOMAIN); ?><span class="arrow-up"></span></li>
...
<div class="wrapper jobseeker" >
	...
	<div class="main-center">
		...
		<div class="jse-basic-info active content-tab" id="jse-basic-info">

			<div class="jse-basic-info-form jse-form" >

				<form action="" id="update_basic-info">

					<input type="hidden" name="ID" value="<?php echo $current_user->ID ?>">

					<div class="jse-input">
                        <br/></br>
                    	<label>Personal info - Coming soon</label>

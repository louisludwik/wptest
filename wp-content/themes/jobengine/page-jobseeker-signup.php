				...
				<div class="jse-signup-form signup-step1">
					<form id="signup">
						...
						<div class="jse-input">
					  	...
					  	<?php } ?>
						<div class="jse-input" style="display: none;">
                        ...
                        <div class="jse-input">
                            ...
                            <div class="input-area">
                                <input type="text" class="bg-default-input required email" name="user_email" id="user_email" value="" onblur="jQuery('#user_name').val(jQuery(this).val())"/>
                            </div>
                        </div>

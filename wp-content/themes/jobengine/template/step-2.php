...
?>
<div class="step <?php if ( et_is_logged_in() ) { echo "current"; } ?> <?php if(!!$job) echo 'completed';?>" id='step_job'>
	...
	<div class="toggle-content login clearfix" <?php if ( !et_is_logged_in() ) { ?> style="display: none" <?php } ?>>
		<div class="form">

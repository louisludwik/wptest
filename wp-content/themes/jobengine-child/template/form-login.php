		...
		<form class="modal-form" id="modal_register" >
			<div class="content">                <div class="form-item" style="display: none;">				  	<div class="label">
				...
				<div class="form-item">
				 	...
				 	<div class="fld-wrap" id="">						<input name="user_email" class="bg-default-input is_email is_user_name not_empty required" id="register_email" type="text" onblur="jQuery('#register_user_name').val(jQuery(this).val())"/>
				  	</div>
				</div>

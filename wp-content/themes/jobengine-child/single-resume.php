		...
		<div id="resume_profile" class="jse-account main-column jse-profile-main jse-signup-profile">
			...
			*/
			...
			if(!empty($resume->et_experience) || $authorise ) {
                ...
                $str_exp = $total_years > 0 ? $total_years . " years " : "";
                $str_exp .= $total_month > 0 ? $total_month . " months " : "";
			...
			<div class="module module-edit education">
				...
				<div class="title">
					<?php _e('Work Experience', ET_DOMAIN); ?> <span id="total_exp"><?=$str_exp?></span>
						...
						<div class="item">
							...
							<div class="content">
								...
								<div class="year">
                                    ...
                                    echo ' ( ';
                                    echo $years > 0 ? $years . " years " : "";
                                    echo $months > 0 ? $months . " months" : "";
                                    echo ' ) ';
									?>
		...
		<div class="widget-area second-column">
			...
			<div class="widget sortable ui-sortable">
				...
				<aside class="widget bg-grey-widget jobseeker-profile-widget">
					...
					<?php
					if ( $resume->anonymous[0]->name == 'Active' ) {
						$avatar = et_get_resume_avatar('', 171);
					} else {

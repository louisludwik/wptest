    ...
    public static function add_view($args){
        ...
        ?>
            ...
            <?php 
                ...
                if (isset($_GET['id']) ){              
                    ...
                    ?>  
                        ...
                        <form action="" method="post" id="fadd" class="et-form" data = "<?php echo $_GET['id'];?>" >                            
                            <?php 
                            if ( isset($_GET['id']) )
                        ...
                        <div class="item">                  
                            <form class="engine-payment-form" action="#" id="et_slide_form">
            ...
            <script type="text/template" id="template_edit_form">
                    <form action="" class="edit-plan engine-payment-form edit-attachment">
                        ...
                        <div class="form payment-plan">
                            ...
                            <div class="form-item">
                                ...
                                <textarea class="bg-grey" id = "et_description" name="description"><%= description %></textarea>
                            </div>
                            <div class="form-item">

...
class ET_Slider_Admin extends ET_Slider_Base{
	...
	public function on_print_scripts(){
		...
		if(isset($_GET['action'])){
			...
			$this->add_script('et-slider-admin',ET_SLIDER_URL . '/js/et_attachment.js', array('jquery', 'et_underscore' ,'et_backbone','job_engine'));
			// wp_enqueue_script('plupload-all');
			// wp_enqueue_script('et-attachment-admin', ET_SLIDER_URL . '/js/et_attachment.js', array('jquery', 'et_underscore' ,'et_backbone','job_engine') );
		}
		else 
			$this->add_script('et-slider-admin', ET_SLIDER_URL . '/js/et_slider_admin.js', array('jquery', 'et_underscore' ,'et_backbone','job_engine'));
			//wp_enqueue_script('et-slider-admin', ET_SLIDER_URL . '/js/et_slider_admin.js', array('jquery', 'et_underscore' ,'et_backbone','job_engine') );

		wp_localize_script( 'job_engine', 'et_slider', array(		
		...
		try{
			switch($method){
				...
				case 'add':
					...
					$response = array('success' => false,'msg' => 'message default');					
								
					$slider = ET_Slider::et_insert_slider($args);
					if ( !($slider instanceof WP_Error) )					
						...
						$response = array('success' => false,'msg' => 'Insert false');			
...
// /post_type=et_slider&orderby=menu_order&order=DESC&post_status=publish&post_parent=0

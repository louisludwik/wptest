	...
	<li class="hidecoupon">
		<div id="coupon_form">
			...
			<div class="coupon-item" style="display:none;">
				<div class="label"><h6 class="font-quicksand"><?php _e('COUPON CODE', ET_DOMAIN );?></h6></div>
				<div class="coupon-input">
					<input type="text" class="bg-default-input" id="coupon_code" />
	...
	*/
	...
	function front_end_script() {
		if(is_page_template('page-post-a-job.php') || is_page_template( 'page-upgrade-account.php' )) {
			...
			wp_localize_script( 'je.coupon.frontend','je_coupon', array('currency'	 => ET_Payment::get_currency()) );
		}
	}
		...
		if(isset($_POST['coupon_code']))  {
			...
			if(!isset($is_available['success'])) {
				...
				if(empty($added_product)) {
					...
					echo json_encode(array('success' => true , 'data' => $is_available['coupon_code'] , 'coupon_price' => $coupon_price ));
					exit;
				}
